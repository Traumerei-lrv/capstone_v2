export const missionScaffolds = {
  recursion: {
    ...
    hint: 'This mission is a placeholder shell for recursion content.',
    ...
    introPoints: ['Topic overview placeholder', 'Learning objective placeholder', 'Example placeholder'],
