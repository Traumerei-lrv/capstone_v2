export const missionScaffolds = {
  recursion: {
    ...
    description: 'Pre-test, intro, visualization, code, and post-test all live in one shared lesson shell.',
    accent: '#4d8ecb',
    ...
    reviewBlurb: 'Post-test review will point back to intro, visualization, and code steps.',
    preTest: {
      title: 'Pre-test',
    ...
    postTest: {
      ...
      choices: ['Intro, visualization, and editable code', 'Only the first question', 'Only the code editor', 'Only the progress bar'],
      correctIndex: 0,
    },
  ...
  iteration: {
    ...
    title: 'Iteration',
    subtitle: 'Reusable mission scaffold',
    description: 'The same lesson shell will later host loop-based content and interactive checks.',
    accent: '#22c55e',
    ...
    postTest: {
      ...
      choices: ['Intro, visualization, and editable code', 'Only the answers you missed', 'Only the first stage', 'Only the final score'],
      correctIndex: 0,
    },
  ...
  'linked-list': {
    ...
    title: 'Linked List',
    subtitle: 'Reusable mission scaffold',
    description: 'The shared shell can later swap in node traversal, pointer updates, and code execution.',
    accent: '#ec4899',
    ...
    postTest: {
      ...
      choices: ['Intro, visualization, and editable code', 'Only the first node', 'Only the reward card', 'Only the sidebar'],
      correctIndex: 0,
    },
